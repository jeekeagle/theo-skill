...
Read `~/.claude/skills/theo-card/assets/poster_template.html`
...
写入：`/tmp/theo_cast_poster_{name}_{N}.html`

## 步骤 7：截图

```bash
node ~/.claude/skills/theo-card/assets/capture.js /tmp/theo_cast_poster_{name}_{N}.html ~/Downloads/{name}_{N}.png 1080 1440
```
