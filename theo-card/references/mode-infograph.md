...
Read `~/.claude/skills/theo-card/assets/infograph_template.html`
...
写入：`/tmp/theo_cast_infograph_{name}.html`
...
```bash
node ~/.claude/skills/theo-card/assets/capture.js /tmp/theo_cast_infograph_{name}.html ~/Downloads/{name}.png 1080 800 fullpage
```
